...
// OJO el nombre del metodo es el mismo que viene aqui
// Porque lo que hacemos es redefinir el metodo controlTextDidChange delegado de la clase NSTextField
// Como heredar la clase con un extends en JAVA

-(IBAction)controlTextDidChange:(NSNotification *)obj;
{
    NSString *cadena = [entradaTexto stringValue];
